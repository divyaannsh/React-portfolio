...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed w-full z-20 top-0 transition-all duration-500 ease-in-out p-6 ${
    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          />
          <span className="text-white text-2xl font-bold">Divyansh Srivastava</span>
        </div>
        ...
        <div className="hidden md:flex space-x-8">
          {['Home', 'About', 'Skills', 'Projects',  'Contact'].map((section) => (
            <Link
              ...
              className={`relative text-white text-lg cursor-pointer transition ${
